...
\begin{frame}{PCB design}
  ...
  \note[item]{To design the pcb, we choose kicad}
  \note[item]{The choice was pretty straight forward, as cern is contributing to the project}
  \note[item]{The reason is to improve open source design sharing}
  \note[item]{The goal is to make it comparable of the mid-end commercial tools}
  ...
  \note[item]{An important feature that made the routing much easier was the push\&shove function}
...
\begin{frame}{PCB validation}
  ...
  \begin{center}
    ...
    picture of mounted pcb top here
  \end{center}
...
\begin{frame}{Backlight}
  ...
  \note[item]{The LCD is perfectly readable during day, even under sunlight}
  \note[item]{But not in the dark or during the night}
  \note[item]{This i why we need a backlight}
...
\begin{frame}{Mechanical design}
  ...
  \note[item]{First we though of using small springs, but to complexe in the end.}
...
\begin{frame}{Building the watch}
  ...
  \item Buy/build a programmer (booloader)
